...
/*
    ...
    Repeat the following untill ptr1 and ptr2 becomes NULL
    if(ptr1 -> expo == ptr2 -> expo)
        Add the coefficient and insert the newly created node in the resulatant linked
        list and make ptr1 and ptr 2 point to the next node
    if(ptr1 -> expo > ptr2 -> expo)
        Insert the node pointed by ptr1 in resultant linked list and make ptr1 point to
        the next node.
    if(ptr2 -> expo > ptr1 -> expo)
        Insert the node pointed by ptr2 in resultant linked list and make ptr2 point to
        the next node.
*/
...
int main(){
    ...
    node *head_1 = NULL;
    head_1 = create_the_polynomial(head_1);
    print_polynomial(head_1);
    printf("Enter the Second polynomial\n");
    node *head_2 = NULL;
    head_2 = create_the_polynomial(head_2);
    print_polynomial(head_2);
    node *head_3 = add_polynomials_using_linked_list(head_1,head_2);
